...
#else
/* 4.14: vdso_data lives in asm/vdso_datapage.h, no vdso/ dir */
...
#else
                /* 4.14: vdso_data has no per-mode clock_mode array and
                 * clocksource has archdata.vdso_direct instead of
                 * vdso_clock_mode; skip the clock-mode alignment. */
                pr_info("ksu: set_spoof_cpu clock-mode alignment skipped (<5.10 vdso layout)\n");
#endif
